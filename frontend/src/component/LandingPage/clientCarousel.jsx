    ...
    return (
        <div class="carousel-wrapper">
            <Carousel infiniteLoop useKeyboardArrows showStatus={false} showArrows={false} showThumbs={false} showIndicators={false}>
                ...
                {/* image */}
                <div>
                <img className="tc_image" src="../images/LandingPageImages/Client_RootedLiving.jpg"></img>
                </div>
                ...
                {/* image */}
                <div>
                <img className="tc_image" src="../images/LandingPageImages/Client_Phoenix.jpg"></img>
                </div>
...
{/* image */}
<div>
<img className="tc_image" src="../images/LandingPageImages/Client_Clickitz.jpg"></img>
</div>
...
{/* image */}
<div>
<img className="tc_image" src="../images/LandingPageImages/Client_HapticPack.jpg"></img>
</div>
...
<img className="cl_button" src="../images/LandingPageImages/clientButton.png"></img>
                ...
                {/* image */}
                <div>
                <img className="tc_image" src="../images/LandingPageImages/Client_Solon.jpg"></img>
                </div>
                ...
                {/* image */}
                <div>
                <img className="tc_image" src="../images/LandingPageImages/Client_ShowNXT.jpg"></img>
                </div>
                ...
                {/* image */}
                <div>
                <img className="tc_image" src="../images/LandingPageImages/Client_ShortFall.jpg"></img>
                </div>
