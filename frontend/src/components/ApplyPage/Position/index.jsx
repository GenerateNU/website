            ...
            <Row className='vh-100 m-0'>
                ...
                <Col xs={6} className='h-100 p-0 py-5 px-5 overflow-auto position-info'>
                    ...
                    <a className='text-decoration-none' href='#'>
                        ...
                        <u> learn more about the (team name) team</u> -- &gt;
                    </a>
                </Col>
            </Row>
        </Container>
