...
export const mobileModalContents = (
  <>
    <div className="h-line" style={{ top: `${constants.TOP_H_LINE}%`, width: "100%" }} />{" "}
    <div
      className="v-line"
    ...
    <Modal.Header
      ...
      style={{
        ...
        left: `${
          constants.MOBILE_RIGHT_V_LINE + (100 - constants.MOBILE_RIGHT_V_LINE) / 2 - 1.75
        }%`,
        zIndex: 100,
      }}
    />
...
export const desktopModalContents = (
  <>
    ...
    <div
      className="h-line"
      style={{ top: `${constants.BOTTOM_H_LINE}%`, width: `${constants.DESKTOP_RIGHT_V_LINE}%` }}
    />
    <Modal.Header
      closeButton
      style={{
        ...
        left: `${
          constants.DESKTOP_RIGHT_V_LINE + (100 - constants.DESKTOP_RIGHT_V_LINE) / 2 - 1.25
        }%`,
        zIndex: 100,
      }}
    />{" "}
