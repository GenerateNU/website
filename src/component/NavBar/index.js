...
import { mobileModalContents, desktopModalContents } from "./NavBarParts/MenuModal";
...
const NavBar = () => {
  ...
  return (
    <div className={`bg-light p-2 mb-5 d-flex bar-size justify-content-around align-items-center border border-dark h-10 w-10 ${mobile && "menu-navbar"}`}>
      {" "}
      {nav}{" "}
      <Modal
