...
//   const Inform = ({ info = softwareInfo, mainColor }) => {
//     return (
//       <div
...
//         )}
//         {/* if(showSoftwareInfo){
//           <Inform info={softwareInfo} mainColor={"white"} />
//         } else if(showHardwareInfo){
//           <Inform info={hardwareInfo} mainColor={"black"} />
//         } */}
//         { showSoftwareInfo? <Inform info={softwareInfo} mainColor={"white"} /> : showHardwareInfo? <Inform info={hardwareInfo} mainColor={"black"} /> : <></> }
...
const WhatWeOffer = () => {
  ...
  let softwareShow = false;
  let hardwareShow = false;
  const [showSoftwareInfo, setShowSoftwareInfo] = useState(softwareShow);
  const [showHardwareInfo, setShowHardwareInfo] = useState(hardwareShow);
  //const [showHighlightSoftware, setHighlightSoftware] = useState(false);
  //const [showHighlightHardware, setHighlightHardware] = useState(false);
      ...
      <div className="position-absolute start-0 top-0 h-100 w-100">
        <div className="vh-20 text-uppercase text-center">
          <div
            ...
            onClick={() => {
              if (hardwareShow) {
                hardwareShow = !hardwareShow;
              }
              console.log(`before negation softwareShow: ${softwareShow}`);

              softwareShow = !softwareShow;
              console.log(`after negation softwareShow: ${softwareShow}`);

              setShowSoftwareInfo(!softwareShow);
              console.log(`hardwareShow: ${hardwareShow}`);
              console.log(`softwareShow: ${softwareShow}`);
            }}
          >
            Software
          </div>
        ...
        <div className="position-relative vh-20 text-center">
          <div
            ...
            onClick={() => {
              ...
              hardwareShow = !hardwareShow;
              setShowHardwareInfo(hardwareShow);
            }}
          >
            Hardware
          </div>
