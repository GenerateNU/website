...
export default function Management() {
  ...
  return (
    <div>
      ...
      <div id="description">
      Setting the yearly vision and ensuring alignment across our organization, 
      we ensure Generate is functioning at its peak. We drive our teams to excel 
      through innovative thinking and build collaborations with other student organizations. 
      Moreover, we work with Sherman Center and Mosaic leadership to position Generate 
      for the future and align each of our goals.' </div>
