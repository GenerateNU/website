...
import {
  findPositionsByCategory,
  findPositionsByCategory2
...
export default function Categories(props) {
  ...
  const getPositionsByCategory = async (categoryType) => {
    console.log('Looking for category of type, ', categoryType);
    const data = await findPositionsByCategory2(categoryType.toString());
  ...
  useEffect(() => {
    ...
    getPositionsByCategory(selectedCategory);
  }, [selectedCategory])
  ...
  const handleSelection = (selected) => {
    ...
    const visible = document
      ...
      .classList.toggle('toggle-container')
        ...
        
        {
          <div className='accordion'>
            ...
            <div id={'management'} className='accordion-content'>
              ...
              {management && management.map((managementPositions) => (
                <div className='accordion_link' key={managementPositions.id}>
                  <Link
                    style={{ textDecoration: 'none', color: '#187DFF' }}
                    to={`/positions/${managementPositions.id}`}
                  >
            ...
            <div
              className='toggle-btn'
              onClick={() => handleSelection('software')}
              id='toggle'
              name='toggle'
            >
            ...
            <div id={'software'} className='accordion-content'>
              ...
              {software.map((softwarePositions) => (
                <div className='accordion_link' key={softwarePositions.id}>
                  <Link
                    style={{ textDecoration: 'none', color: '#187DFF' }}
                    to={`/positions/${softwarePositions.id}`}
                  >
            ...
            <div
              className='toggle-btn'
              onClick={() => handleSelection('hardware')}
              id='toggle'
              name='toggle'
            >
            ...
            <div id={'hardware'} className='accordion-content'>
              ...
              {hardware.map((hardwarePositions) => (
                <div className='accordion_link' key={hardwarePositions.id}>
                  <Link
                    style={{ textDecoration: 'none', color: '#187DFF' }}
                    to={`/positions/${hardwarePositions.id}`}
                  >
            ...
            <div
              className='toggle-btn'
              onClick={() => handleSelection('operations')}
              id='toggle'
              name='toggle'
            >
            ...
            <div id={'operations'} className='accordion-content'>
              ...
              {operations.map((operationsPositions) => (
                <div className='accordion_link' key={operationsPositions.id}>
                  <Link
                    style={{ textDecoration: 'none', color: '#187DFF' }}
                    to={`/positions/${operationsPositions.id}`}
                  >
            ...
            <div
              className='toggle-btn'
              onClick={() => handleSelection('engagement')}
              id='toggle'
              name='toggle'
            >
            ...
            <div id={'engagement'} className='accordion-content'>
              ...
              {engagement.map((engagementPositions) => (
                <div className='accordion_link' key={engagementPositions.id}>
                  <Link
                    style={{ textDecoration: 'none', color: '#187DFF' }}
                    to={`/positions/${engagementPositions.id}`}
                  >
