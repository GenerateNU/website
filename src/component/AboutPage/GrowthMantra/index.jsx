    ...
    <div className="background-white">
      ...
      <div className="alignItemsRight">
        ...
        <div className="paragraphTextGrowthMantra">
          We always encourage our members to take on new challenges. We don’t
          expect members to come in with all the skills required to excel on a
          project; passion can get you a long way in Generate. Tools and
          resources are only an ask away, and we strive to provide an
          environment where members can test out their ideas.
        </div>
