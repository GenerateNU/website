const Clients = [
  {
    ...
    description:
      "Have an idea for a product but don't have the technical background to build it? Have an existing product that you want new features added to? Apply to be a Generate client! We work semesterly on a wide variety of Hardware & Software projects that meet our client's needs, to help them advance to the next stage of their venture's development. Don't know if your project is a good fit? Still apply and we'll work with you to determine feasibility and capability!",
    responsibilities:
      'Work with your Project Lead (PL) on crafting a scope that best fits your goals and the capabilities of our team. Meet with your PL (and occasionally your entire team) regularly. Sit back, relax, and allow us to build your product and advance your venture!',
    requirements:
      'The client has retained Generate for the purpose of designing, consulting, and other related services for a project',
    startDate: '1/8/2024',
    endDate: '4/12/2024',
    workCommitment: 0,
    active: true,
    remarks:
      'The position begins and ends with the Northeastern academic semester. The last day to apply is November 1st.',
    applicationLink:
  ...
  // this is a bogus app for testing purposes, delete later
  {
    ...
    categoryType: 'Clients',
    description:
      "If you're seeking innovative solutions for your business, project, or startup, apply to have Generate turn your ideas into reality.",
    responsibilities:
